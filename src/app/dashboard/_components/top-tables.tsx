    ...
    return (
        <Table>
            <TableHeader>
                <TableHeadRow>
                    <TableHead>
                        <Skeleton className="my-1 h-6 sm:h-8 w-12 sm:w-16 rounded-lg" />
                    </TableHead>
                    <TableHead>
                        <Skeleton className="my-1 h-6 sm:h-8 w-28 sm:w-52 rounded-lg" />
                    </TableHead>
                    <TableHead>
                        <Skeleton className="my-1 h-6 sm:h-8 w-12 sm:w-16 rounded-lg" />
                    </TableHead>
            ...
            <TableBody>
                {Array.from({ length: limit }, (_, index) => (
                    <TableRow key={index}>
                        <TableCell>
                            <Skeleton className="h-5 sm:h-6 w-8 sm:w-12 rounded-lg" />
                        </TableCell>
                        <TableCell>
                            <div className="flex items-center gap-1 sm:gap-4">
                                <Skeleton className="h-9 w-9 sm:h-12 sm:w-12 rounded-lg" />
                                <Skeleton className="h-5 sm:h-6 w-20 sm:w-32 rounded-lg" />
                            </div>
                        </TableCell>
                        <TableCell>
                            <Skeleton className="h-5 sm:h-6 w-8 sm:w-12 rounded-lg" />
            ...
            <TableBody>
                {artistComparisons.map((artist, index) => (
                    <TableRow key={artist.artistId}>
                        ...
                        <TableCell>
                            <Link
                                className="flex h-10 sm:h-12 items-center gap-1 sm:gap-2 text-wrap underline-offset-4 hover:underline xs:gap-2 sm:xs:gap-4"
                            ...
                            >
                                ...
                                <span className="text-xs sm:text-sm line-clamp-2 xs:line-clamp-none">
                                    {artist.artist}
                                </span>
                            </Link>
                        </TableCell>
                        <TableCell>
                            <div className="flex flex-col items-start gap-1 xs:flex-row xs:items-center xs:gap-2">
                                <span className="text-xs sm:text-sm">{artist.count}</span>
                                <PercentageBadge
            ...
            <TableBody>
                {trackComparisons.map((track, index) => (
                    <TableRow key={track.trackId}>
                        ...
                        <TableCell>
                            <div className="flex flex-col items-start gap-1 xs:flex-row xs:items-center xs:gap-2">
                                <span className="text-xs sm:text-sm">{track.count}</span>
                                <PercentageBadge
            ...
            <TableBody>
                {albumComparisons.map((album, index) => (
                    <TableRow key={album.albumId}>
                        ...
                        <TableCell>
                            <div className="flex flex-col items-start gap-1 xs:flex-row xs:items-center xs:gap-2">
                                <span className="text-xs sm:text-sm">{album.count}</span>
                                <PercentageBadge
