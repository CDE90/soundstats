            ...
            <div className="mx-auto max-w-4xl space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <p>
                            This Privacy Policy explains how SoundStats
                            collects, uses, and protects your information when
                            you use our service. We are committed to ensuring
                            that your privacy is protected and that we comply
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <p>
                            When you use SoundStats, we collect the following
                            types of information:
                        </p>
                        <ul className="list-disc space-y-2 pl-6">
                            <li>
                                <strong>Account Information:</strong> When you
                                sign in with Spotify, we receive basic profile
                                information including your username, profile
                                picture, and email address.
                            </li>
                            <li>
                                <strong>Spotify Listening Data:</strong> We
                                collect data related to your Spotify listening
                                history, including your most played tracks,
                                artists, albums, and your listening patterns.
                            </li>
                            <li>
                                <strong>Usage Data:</strong> We collect
                                information about how you interact with
                                SoundStats, including the features you use and
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="list-disc space-y-2 pl-6">
                            ...
                            <li>
                                To generate personalized music statistics and
                                visualizations
                            </li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="list-disc space-y-2 pl-6">
                            <li>
                                ...
                                your information with third-party service
                                providers that help us operate, deliver, and
                                improve our service.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                your information with your consent or at your
                                direction.
                            </li>
                        </ul>
                    </div>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <p>
                            ...
                            the methods listed in Section 10.
                        </p>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <p>
                            ...
                            &quot;Last updated&quot; date. You are advised to
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <p>
                            ...
                            GitHub repository or via the contact information
