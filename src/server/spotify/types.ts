/*
This file is a copy of the spotify-web-api-ts-sdk types file.
See here: https://github.com/spotify/spotify-web-api-ts-sdk/blob/main/src/types.ts
...
export interface IHandleErrors {
    handleErrors(error: unknown): Promise<boolean>;
}
